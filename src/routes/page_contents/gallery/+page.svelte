...
<Modal bind:showModal>
	<div class="">
<div class="m-10 p-5 rounded md:rounded-lg bg-base-100 max-h-200 lg:w-xl">
  <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-xs lg:w-lg border p-1 h-150 lg:h-110 overflow-auto">
    <legend class="fieldset-legend">{modalOperation}: {modalHeader}</legend>
    <div class="grid m-2 p-2 lg:flex lg:gap-4 lg:w-lg ">
     
    <div class="grid lg:w-1/3">
